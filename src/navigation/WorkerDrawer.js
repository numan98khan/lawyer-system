...
class MainDrawer extends Component {
  ...
  render() {
    return (
      <Fragment>
        <Drawer
          open={this.props.user.isDrawerVisible}
        ...
        >
          <div style={{ width: 250 }}>
            ...
            <List>
              ...
              >
                <ListItem button key={"View Cases"}>
              ...
              >
                <ListItem button key={"View Clients"}>
...
export default connect(mapStateToProps, { toggleDrawer })(MainDrawer);
